...
class Alias(object):
    ...
    def __init__(self):
        ...
        self.mission_list = mission.get_lj_param(u'苏州')
    ...
    def get_alias(self):
        for item in self.mission_list:
            ...
            res = requests.get(url='http://su.lianjia.com/headerMind.json?', params=data, headers=header)
